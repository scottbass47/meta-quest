...
public class ParticleFactory {
	...
	public static void spawnJumpParticle(Entity entity){
		...
		Entity particle = EntityFactory.createParticle(engine, world, level, AssetLoader.getInstance().getAnimation(Asset.JUMP_PARTICLE), body.getPosition().x, body.getPosition().y + yOff);
